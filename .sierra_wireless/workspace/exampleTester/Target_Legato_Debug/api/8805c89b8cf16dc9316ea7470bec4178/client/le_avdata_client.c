...
static void InitCommonData(void)
{
    ...
    _ClientDataPool = le_mem_CreatePool("le_avdata_ClientData", sizeof(_ClientData_t));

    // Allocate the client thread pool
    _ClientThreadDataPool = le_mem_CreatePool("le_avdata_ClientThreadData", sizeof(_ClientThreadData_t));
    ...
    _HandlerRefMap = le_ref_CreateMap("le_avdata_ClientHandlers", 5);
}
...
static void _Handle_le_avdata_AddResourceEventHandler
(
    void* _reportPtr,
    void* _dataPtr
)
{
    ...
    le_avdata_ResourceHandlerFunc_t _handlerRef_le_avdata_AddResourceEventHandler = (le_avdata_ResourceHandlerFunc_t)_clientDataPtr->handlerPtr;
    ...
    if ( _handlerRef_le_avdata_AddResourceEventHandler != NULL )
    {
        _handlerRef_le_avdata_AddResourceEventHandler(path, accessType, argumentListRef, contextPtr );
    }
    else
    {
...
)
{
    ...
    _UNLOCK
    handlerRef = (le_avdata_ResourceEventHandlerRef_t)clientDataPtr->handlerRef;
...
)
{
    ...
    // Unpack any "out" parameters
    if (valuePtr &&
        (!le_pack_UnpackDouble( &_msgBufPtr, &_msgBufSize,
                                               valuePtr )))
    {
        goto error_unpack;
    }
...
)
{
    ...
    if (strArg)
    {
        LE_ASSERT(le_pack_PackSize( &_msgBufPtr, &_msgBufSize, (strArgSize-1) ));
    }
...
// This function parses the message buffer received from the server, and then calls the user
// registered handler, which is stored in a client data object.
static void _Handle_le_avdata_Push
(
    void* _reportPtr,
    void* _dataPtr
)
{
    ...
    // Pull out additional data from the client data pointer
    le_avdata_CallbackResultFunc_t _handlerRef_le_avdata_Push = (le_avdata_CallbackResultFunc_t)_clientDataPtr->handlerPtr;
    void* contextPtr = _clientDataPtr->contextPtr;
    ...
    // Call the registered handler
    if ( _handlerRef_le_avdata_Push != NULL )
    {
        _handlerRef_le_avdata_Push(status, contextPtr );
    }
    else
    {
        LE_FATAL("Error in client data: no registered handler");
...
// This function parses the message buffer received from the server, and then calls the user
// registered handler, which is stored in a client data object.
static void _Handle_le_avdata_PushStream
(
    void* _reportPtr,
    void* _dataPtr
)
{
    ...
    // Pull out additional data from the client data pointer
    le_avdata_CallbackResultFunc_t _handlerRef_le_avdata_PushStream = (le_avdata_CallbackResultFunc_t)_clientDataPtr->handlerPtr;
    void* contextPtr = _clientDataPtr->contextPtr;
    ...
    // Call the registered handler
    if ( _handlerRef_le_avdata_PushStream != NULL )
    {
        _handlerRef_le_avdata_PushStream(status, contextPtr );
    }
    else
    {
        LE_FATAL("Error in client data: no registered handler");
...
// This function parses the message buffer received from the server, and then calls the user
// registered handler, which is stored in a client data object.
static void _Handle_le_avdata_PushRecord
(
    void* _reportPtr,
    void* _dataPtr
)
{
    ...
    // Pull out additional data from the client data pointer
    le_avdata_CallbackResultFunc_t _handlerRef_le_avdata_PushRecord = (le_avdata_CallbackResultFunc_t)_clientDataPtr->handlerPtr;
    void* contextPtr = _clientDataPtr->contextPtr;
    ...
    // Call the registered handler
    if ( _handlerRef_le_avdata_PushRecord != NULL )
    {
        _handlerRef_le_avdata_PushRecord(status, contextPtr );
    }
    else
    {
        LE_FATAL("Error in client data: no registered handler");
...
// This function parses the message buffer received from the server, and then calls the user
// registered handler, which is stored in a client data object.
static void _Handle_le_avdata_AddSessionStateHandler
(
    void* _reportPtr,
    void* _dataPtr
)
{
    ...
    // Pull out additional data from the client data pointer
    le_avdata_SessionStateHandlerFunc_t _handlerRef_le_avdata_AddSessionStateHandler = (le_avdata_SessionStateHandlerFunc_t)_clientDataPtr->handlerPtr;
    void* contextPtr = _clientDataPtr->contextPtr;
    ...
    // Call the registered handler
    if ( _handlerRef_le_avdata_AddSessionStateHandler != NULL )
    {
        _handlerRef_le_avdata_AddSessionStateHandler(sessionState, contextPtr );
    }
    else
    {
        LE_FATAL("Error in client data: no registered handler");
...
)
{
    ...
    le_ref_DeleteRef(_HandlerRefMap, handlerRef);
    _UNLOCK
    handlerRef = (le_avdata_SessionStateHandlerRef_t)clientDataPtr->handlerRef;
    le_mem_Release(clientDataPtr);
    LE_ASSERT(le_pack_PackReference( &_msgBufPtr, &_msgBufSize,
                                     handlerRef ));
...
)
{
    ...
    switch (msgPtr->id)
    {
        case _MSGID_le_avdata_AddResourceEventHandler :
            le_event_QueueFunctionToThread(callersThreadRef, _Handle_le_avdata_AddResourceEventHandler, msgRef, clientDataPtr);
            break;
        case _MSGID_le_avdata_Push :
            le_event_QueueFunctionToThread(callersThreadRef, _Handle_le_avdata_Push, msgRef, clientDataPtr);
            break;
        case _MSGID_le_avdata_PushStream :
            le_event_QueueFunctionToThread(callersThreadRef, _Handle_le_avdata_PushStream, msgRef, clientDataPtr);
            break;
        case _MSGID_le_avdata_PushRecord :
            le_event_QueueFunctionToThread(callersThreadRef, _Handle_le_avdata_PushRecord, msgRef, clientDataPtr);
            break;
        case _MSGID_le_avdata_AddSessionStateHandler :
            le_event_QueueFunctionToThread(callersThreadRef, _Handle_le_avdata_AddSessionStateHandler, msgRef, clientDataPtr);
            break;
