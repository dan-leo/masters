...
// Startup code for the executable 'assetData'.
...
LE_SHARED const char* _assetDataComponent_le_avdata_ServiceInstanceName = "assetData.assetDataComponent.le_avdata";

// Define default component's log session variables.
LE_SHARED le_log_SessionRef_t assetData_exe_LogSession;
LE_SHARED le_log_Level_t* assetData_exe_LogLevelFilterPtr;
...
int main(int argc, char* argv[])
{
    ...
    assetData_exe_LogSession = log_RegComponent("assetData_exe", &assetData_exe_LogLevelFilterPtr);
    ...
    LoadLib("libComponent_assetDataComponent.so");
