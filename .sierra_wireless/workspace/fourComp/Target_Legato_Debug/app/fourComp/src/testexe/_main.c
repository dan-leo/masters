...
// Startup code for the executable 'testexe'.
...
LE_SHARED le_log_SessionRef_t testexe_exe_LogSession;
LE_SHARED le_log_Level_t* testexe_exe_LogLevelFilterPtr;
...
int main(int argc, char* argv[])
{
    ...
    testexe_exe_LogSession = log_RegComponent("testexe_exe", &testexe_exe_LogLevelFilterPtr);
