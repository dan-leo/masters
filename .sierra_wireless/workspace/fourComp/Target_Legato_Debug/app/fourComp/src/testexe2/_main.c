...
// Startup code for the executable 'testexe2'.
...
LE_SHARED le_log_SessionRef_t testexe2_exe_LogSession;
LE_SHARED le_log_Level_t* testexe2_exe_LogLevelFilterPtr;
...
int main(int argc, char* argv[])
{
    ...
    testexe2_exe_LogSession = log_RegComponent("testexe2_exe", &testexe2_exe_LogLevelFilterPtr);
    ...
    LoadLib("libComponent_d.so");
    LoadLib("libComponent_c.so");
    LoadLib("libComponent_b.so");
