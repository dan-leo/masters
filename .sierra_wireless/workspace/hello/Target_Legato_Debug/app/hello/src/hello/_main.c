...
// Startup code for the executable 'hello'.
...
LE_SHARED le_log_SessionRef_t hello_exe_LogSession;
LE_SHARED le_log_Level_t* hello_exe_LogLevelFilterPtr;
...
int main(int argc, char* argv[])
{
    ...
    hello_exe_LogSession = log_RegComponent("hello_exe", &hello_exe_LogLevelFilterPtr);
    ...
    LoadLib("libComponent_helloComponent.so");
