...
// Startup code for the executable 'hi'.
...
LE_SHARED le_log_SessionRef_t hi_exe_LogSession;
LE_SHARED le_log_Level_t* hi_exe_LogLevelFilterPtr;
...
int main(int argc, char* argv[])
{
    ...
    hi_exe_LogSession = log_RegComponent("hi_exe", &hi_exe_LogLevelFilterPtr);
