...
def test_echo_send(request):
    ...
    if pytest.vendor == 'quectel':
        ...
        OK('AT+NSOCR=DGRAM,17,4444')
        if big:
            expect('AT+NSOSTF=1,34.74.25.60,5555,0x400,3,', '+NSONMI:1', 300)
        else:
