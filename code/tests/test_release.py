...
def test_release_release16(request):
    ...
    if pytest.vendor == 'ublox':
        ...
        OK('AT+NSOCR=DGRAM,17,14000,1')
        for i in range(1):
            expect('AT+NSOSTF=1,1.1.1.1,7,0x200,16,FFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFF', '+CSCON:0', 300)
            capture(1)
        OK('at+nsocl=1')
...
def test_release_release64(request):
    ...
    if pytest.vendor == 'ublox':
        ...
        OK('AT+NSOCR=DGRAM,17,14000,1')
        for i in range(1):
            expect('AT+NSOSTF=1,1.1.1.1,7,0x200,64,FFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFF', '+CSCON:0', 300)
            capture(1)
        OK('at+nsocl=1')
