...
# @pytest.mark.release
def test_release_rrelease0(request):
    pytest.subtest = request.node.name.split('_')[-1] + '/'
...
def test_release_release16(request):
    ...
    if pytest.vendor == 'ublox':
        ...
        for i in range(5):
            OK('AT+NSOCR="DGRAM",17,14000,1')
            expect('AT+NSOSTF=0,"1.1.1.1",7,0x200,16,"FFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFF"', '+CSCON: 0', 300)
            OK('at+nsocl=0')
            capture(1)
    elif pytest.vendor == 'quectel':
        expect('at+nsocl=1', '')
        ...
        OK('AT+NSOCR=DGRAM,17,14000,1')
        for i in range(5):
            expect('AT+NSOSTF=1,1.1.1.1,7,0x200,16,FFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFF', '', 1) #['+CSCON:0', '+NPSMR:'], 300)
            capture(1)
        OK('at+nsocl=1')
...
def test_release_release64(request):
    ...
    if pytest.vendor == 'ublox':
        for i in range(5):
            OK('AT+NSOCR="DGRAM",17,14000,1')
            expect('AT+NSOSTF=0,"1.1.1.1",7,0x200,64,"FFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFF"', '+CSCON: 0', 300)
            OK('at+nsocl=0')
            capture(1)
    elif pytest.vendor == 'quectel':
        expect('at+nsocl=1', '')
        ...
        OK('AT+NSOCR=DGRAM,17,14000,1')
        for i in range(5):
            expect('AT+NSOSTF=1,1.1.1.1,7,0x200,64,FFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFF', '', 1) #['+CSCON:0', '+NPSMR:'], 300)
            capture(1)
        OK('at+nsocl=1')
...
def test_release_release128(request):
    ...
    if pytest.vendor == 'ublox':
        ...
        OK('AT+NSOCR=DGRAM,17,14000,1')
        for i in range(5):
            expect('AT+NSOSTF=1,1.1.1.1,7,0x200,128,', '', 1) #['+CSCON:0', '+NPSMR:'], 300)
            capture(1)
        OK('at+nsocl=1')
...
def test_release_release256(request):
    ...
    if pytest.vendor == 'ublox':
        ...
        OK('AT+NSOCR=DGRAM,17,14000,1')
        for i in range(5):
            expect('AT+NSOSTF=1,1.1.1.1,7,0x200,256,', '', 1) #['+CSCON:0', '+NPSMR:'], 300)
            capture(1)
        OK('at+nsocl=1')
...
def test_release_release512(request):
    ...
    if pytest.vendor == 'ublox':
        ...
        OK('AT+NSOCR=DGRAM,17,14000,1')
        for i in range(5):
            expect('AT+NSOSTF=1,1.1.1.1,7,0x200,512,', '', 1) #['+CSCON:0', '+NPSMR:'], 300)
            capture(1)
        OK('at+nsocl=1')
