...
pandoc "%~1" -H ..\fix-captions.tex -F pandoc-tablenos -F pandoc-crossref -F pandoc-citeproc --mathjax --standalone -o "%file:~0,-2%tex" --pdf-engine=xelatex --bibliography ..\library.bib --toc-depth=3
